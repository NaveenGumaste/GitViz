  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8" id="demo-preview">
      <div className="space-y-6">
        <p className="text-sm font-semibold uppercase tracking-[0.28em] text-muted">Live demo preview</p>
        <h2 className="font-display text-[clamp(2.2rem,4vw,3.8rem)] leading-[0.95] tracking-[-0.05em]">
          The dashboard, framed like a browser and styled like an editorial spread.
        </h2>
      </div>

      <Card className="mt-12 overflow-hidden p-0">
        <div className="border-b border-border bg-surface-light px-5 py-4 dark:border-border-dark dark:bg-surface">
          <div className="flex items-center gap-2">
            <span className="size-3 rounded-full bg-[#ff5f57]" />
            <span className="size-3 rounded-full bg-[#febc2e]" />
            <span className="size-3 rounded-full bg-[#28c840]" />
            <div className="ml-4 rounded-full bg-paper px-4 py-1 text-xs text-muted dark:bg-ink/60 dark:text-paper/70">
        ...
        <div className="grid gap-4 p-5 lg:grid-cols-[260px_minmax(0,1fr)]">
          <div className="rounded-[1.5rem] border border-border bg-paper p-4 dark:border-border-dark dark:bg-surface">
          ...
          <div className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-[1.5rem] border border-border bg-paper p-5 dark:border-border-dark dark:bg-surface">
